...
export async function loadYpareoPlacementDraft(
  ...
  const employer: YpareoDraftSection = {
    ...
    fields: [
      ...
      field("Convention collective", need?.companyCollectiveAgreement, true),
      field("OPCO", need?.companyOpco, true),
      field("Caisse retraite complementaire", need?.companyRetirementFund, true),
      field("Representant employeur", fullName(need?.companyLegalRepFirstName, need?.companyLegalRepLastName), true),
